  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        console.log('jwdojwodjwojoonfjkflljmql',userResponse.data);
...
image: userResponse.data.image
    ,
          ...
          _id: userResponse.data._id || null,
        }));
      } catch (error) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[300px] bg-slate-50 dark:bg-gray-800 rounded-lg shadow-lg p-4 z-50">
