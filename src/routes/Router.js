...
const ManageLeads = Loadable(lazy(() => import('../Pages/ManageLeads')));

const LeadDetails = Loadable(lazy(() => import('../Pages/LeadDetails')));
const AddLeads = Loadable(lazy(() => import('../Pages/AddLeads')));
const EditLeads = Loadable(lazy(() => import('../Pages/Editleads')));

const ManageClients = Loadable(lazy(() => import('../Pages/ManageClients')));
const ClientDetails = Loadable(lazy(() => import('../Pages/ClientDetails')));
const AddClients = Loadable(lazy(() => import('../Pages/AddClients')));
const EditClients = Loadable(lazy(() => import('../Pages/EditClients')));


const ManageProjects = Loadable(lazy(() => import('../Pages/ManageProjects'))); 
const ProjectDetails = Loadable(lazy(() => import('../Pages/ProjectDetails')));
const AddProjects = Loadable(lazy(() => import('../Pages/AddProjects')));
const EditProjects = Loadable(lazy(() => import('../Pages/EditProjects')));



const TaskDetails = Loadable(lazy(() => import('../Pages/TaskDetails')));
const ManageTasks = Loadable(lazy(() => import('../Pages/ManageTasks')));
const AddTasks = Loadable(lazy(() => import('../Pages/AddTasks')));
const EditTasks = Loadable(lazy(() => import('../Pages/EditTasks')));


const ManageTeam = Loadable(lazy(() => import('../Pages/ManageTeam')));
const TeamDetails = Loadable(lazy(() => import('../Pages/TeamDetails')));
const AddTeams = Loadable(lazy(() => import('../Pages/AddTeam')));
const EditTeams = Loadable(lazy(() => import('../Pages/EditTeam')));

const ManageRoles = Loadable(lazy(() => import('../Pages/ManageRole')));
const AddRoles = Loadable(lazy(() => import('../Pages/AddRole')));
const EditRoles = Loadable(lazy(() => import('../Pages/EditRole')));
const RoleDetails = Loadable(lazy(() => import('../Pages/RoleDetails')));


const ManageServices = Loadable(lazy(() => import('../Pages/ManageServices')));
const AddServices = Loadable(lazy(() => import('../Pages/AddServices')));
const EditServices = Loadable(lazy(() => import('../Pages/EditServices')));
const ServiceDetails = Loadable(lazy(() => import('../Pages/ServiceDetails')));

const ManageOffer = Loadable(lazy(() => import('../Pages/ManageOffersBanner')));
const AddOffer = Loadable(lazy(() => import('../Pages/AddOfferBanner')));
const EditOffer = Loadable(lazy(() => import('../Pages/EditOfferBanner')));
const OfferDetails = Loadable(lazy(() => import('../Pages/OfferBannerDetails')));



const ClientProjects = Loadable(lazy(() => import('../Pages/ClientProjects')));
const ClientProjectsDetails = Loadable(lazy(() => import('../Pages/ClientProjetDetails')));

const EditClientProjects = Loadable(lazy(() => import('../Pages/EditProjectByClient')));
const EditClientTasks = Loadable(lazy(() => import('../Pages/EditTaskByClient')));
const EditTeamTasks= Loadable(lazy(()=> import('../Pages/EditTaskbyTeammember')));
const ClientTasks = Loadable(lazy(() => import('../Pages/ClientTasks')));

const AssignTasks = Loadable(lazy(() => import('../Pages/AssignedTasks')));

const EditUserProfile = Loadable(lazy(() => import('../Pages/EditProfile')));
const TeamMemberTaskDetails = Loadable(lazy(() => import('../Pages/TeamMemberTaskDetails')));


const SalaryManagement = Loadable(lazy(() => import('../Pages/SalaryManagement')));




const TeamAttendance = Loadable(lazy(() => import('../Pages/AttandanceView')));


const LeaveManagement = Loadable(lazy(() => import('../Pages/LeaveManagement')));

const LeaveApplay = Loadable(lazy(() => import('../Pages/LeaveApply')));

const ManageReportByTeam = Loadable(lazy(() => import('../Pages/ManageReportByTeam')));

const ManageReport = Loadable(lazy(() => import('../Pages/ManageReport')));

const AddReport = Loadable(lazy(() => import('../Pages/AddReport')));
...
const Router = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/manageleads',  exact: true,element: <ManageLeads/>,  },
      { path: '/addleads',  exact: true, element: <AddLeads  /> },
      { path: '/editleads/:id', exact: true, element: <EditLeads/> },
      { path: '/leaddetails/:id', exact: true, element: <LeadDetails/> },

      { path: '/manageclients', exact: true, element: <ManageClients/> },
      { path: '/addclient', exact: true, element: <AddClients/> },
      { path: '/editclients/:id', exact: true, element: <EditClients/> },
      { path: '/clientdetails/:id', exact: true, element: <ClientDetails/> },


      { path: '/manageprojects', exact: true, element: <ManageProjects/> },
      { path: '/addprojects', exact: true, element: <AddProjects/> },
      { path: '/editprojects/:id', exact: true, element: <EditProjects/> },
      { path: '/projectdetails/:id', exact: true, element: <ProjectDetails/> },

      { path: '/manageTasks', exact: true, element: <ManageTasks/> },
      { path: '/addTasks', exact: true, element: <AddTasks/> },
      { path: '/editTasks/:id', exact: true, element: <EditTasks/> },
      { path: '/taskdetails/:id', exact: true,element: <TaskDetails/> },
      { path: '/teammembertaskdetails/:id', exact: true,element: <TeamMemberTaskDetails/> },
      { path: '/manageTeams', exact: true, element: <ManageTeam/> },
      { path: '/addTeam', exact: true, element: <AddTeams/> },
      { path: '/editTeam/:id', exact: true, element: <EditTeams/> },
      { path: '/teamdetails/:id', exact: true, element: <TeamDetails/> },

      { path: '/assignedtasks', exact: true, element: <AssignTasks/> },
      { path: '/clientprojects', exact: true, element: <ClientProjects/> },
      { path: '/editprojectbyclient/:id', exact: true, element: <EditClientProjects/> },
      { path: '/clienttasks',  exact: true,element: <ClientTasks/> },
      { path: '/edittaskbyclient/:id', exact: true, element: <EditClientTasks/> },
      { path: '/edittaskbyteammember/:id', exact: true, element: <EditTeamTasks/> },
      { path: '/manageroles', exact: true, element: <ManageRoles/> },
      { path: '/addrole', exact: true, element: <AddRoles/> },
      { path: '/editrole/:id', exact: true, element: <EditRoles/> },
      { path: '/roledetails/:id', exact: true, element: <RoleDetails/> },
     
      { path: '/editprofile/:id', exact: true, element: <EditUserProfile/> },
      { path: '/clientprojectdetails/:id', exact: true, element: <ClientProjectsDetails/> },

      { path: '/manageservices', exact: true, element: <ManageServices/> },
      { path: '/addservices', exact: true, element: <AddServices/> },
      { path: '/editservices/:id', exact: true, element: <EditServices/> },
      { path: '/servicedetails/:id', exact: true, element: <ServiceDetails/> },

      
      { path: '/manageoffers', exact: true, element: <ManageOffer/> },
      { path: '/addoffer', exact: true, element: <AddOffer/> },
      { path: '/editoffer/:id', exact: true, element: <EditOffer/> },
      { path: '/offerdetails/:id', exact: true, element: <OfferDetails/> },


      { path: '/salarymanagement', exact: true, element: <SalaryManagement/> },


      { path: '/attandanceview', exact: true, element: <TeamAttendance/> },

      { path: '/leaveapplay', exact: true, element: <LeaveApplay/> },

      { path: '/leavemenagement', exact: true, element: <LeaveManagement/> },

      { path: '/managereport', exact: true, element: <ManageReport/> },
      { path: '/addreport', exact: true, element: <AddReport/> },
      { path: '/managereportbyteam', exact: true, element: <ManageReportByTeam/> },





      { path: '/dashboards/e-commerce',  exact: true, element: <ECommerceDash /> },
